     ...
     <form @submit.prevent="submitForm">
        <div class="form-row">
          <div class="form-group">
             ...
             <input type="text" class="form-control" v-model.trim="$v.collegeName.$model" :class="{'is-invalid':$v.collegeName.$error, 'is-valid':!$v.collegeName.$invalid}">        
             <div class="valid-feedback">Your college name is valid!</div>
             <div class="invalid-feedback">
                <span v-if="!$v.collegeName.required">College Name is required</span>
             </div>
          </div>
